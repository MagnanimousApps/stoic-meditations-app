quotes = [
    ...
    "To read with diligence; not to rest satisfied with a light and superficial knowledge, nor quickly to assent to things commonly spoken of: whom also I must thank that ever I lighted upon Epictetus his _Hypomnemata_, or moral commentaries and common-factions: which also he gave me of his own.",
    ...
    "A man without ever the least appearance of anger, or any other passion; able at the same time most exactly to observe the Stoic _Apathia_, or unpassionateness, and yet to be most tender-hearted: ever of good credit; and yet almost without any noise, or rumour: very learned, and yet making little show.",
    ...
    "He would not hastily give over the search of the matter, as one easy to be satisfied with sudden notions and apprehensions.",
    ...
    "In the country of the Quadi at Granua, these.",
    ...
    "or angry, and ill affected towards him, who by nature is so near unto me?",
    ...
    "For indeed this latter may seem first to have been wronged, and so in some manner through grief thereof to have been forced to be angry, whereas he who through lust doth commit anything, did of himself merely resolve upon that action.",
    ...
    "It cannot be that she through want either of power or skill, should have committed such a thing, so as to suffer all things both good and bad, equally and promiscuously, to happen unto all both good and bad.",
    ...
    "Now death, it is not only a work of nature, but also conducing to nature.",
    ...
    "For even the least things ought not to be done, without relation unto the end; and the end of the reasonable creatures is, to follow and obey him, who is the reason as it were, and the law of this great city, and ancient commonwealth.",
    ...
    "_Whilst I was at Carnuntum._ THE THIRD BOOK I.",
    ...
    "So will he behold with as much pleasure the true _rictus_ of wild beasts, as those which by skilful painters and other artificers are imitated.",
    ...
    "Hippocrates having cured many sicknesses, fell sick himself and died.",
    "The Chaldeans and Astrologians having foretold the deaths of divers, were afterwards themselves surprised by the fates.",
    "Alexander and Pompeius, and Caius Cæsar, having destroyed so many towns, and cut off in the field so many thousands both of horse and foot, yet they themselves at last were fain to part with their own lives.",
    ...
    "Thou hast taken ship, thou hast sailed, thou art come to land, go out, if to another life, there also shalt thou find gods, who are everywhere.",
    "If all life and sense shall cease, then shalt thou cease also to be subject to either pains or pleasures; and to serve and tend this vile cottage; so much the viler, by how much that which ministers unto it doth excel; the one being a rational substance, and a spirit, the other nothing but earth and blood.",
    ...
    "For that lot and portion which is assigned to every one, as it is unavoidable and necessary, so is it always profitable.",
    ...
    "Now, that they say is best, which is most profitable.",
    ...
    "how much in regard of man, a citizen of the supreme city, of which all other cities in the world are as it were but houses and families?",
    "What is this, that now my fancy is set upon?",
    "of what things doth it consist?",
    "which of all the virtues is the proper virtue for this present use?",
    "as whether meekness, fortitude, truth, faith, sincerity, contentation, or any of the rest?",
    "Of everything therefore thou must use thyself to say, This immediately comes from God, this by that fatal connection, and concatenation of things, or (which almost comes to one) by some coincidental casualty.",
    "And as for this, it proceeds from my neighbour, my kinsman, my fellow: through his ignorance indeed, because he knows not what is truly natural unto him: but I know it, and therefore carry myself towards him according to the natural law of fellowship; that is kindly, and justly.",
    ...
    "Be not deceived; for thou shalt never live to read thy moral commentaries, nor the acts of the famous Romans and Grecians; nor those excerpta from several books; all which thou hadst provided and laid up for thyself against thine old age.",
    ...
    "To steal, to sow, to buy, to be at rest, to see what is to be done (which is not seen by the eyes, but by another kind of sight:) what these words mean, and how many ways to be understood, they do not understand.",
    "The body, the soul, the understanding.",
    ...
    "To be capable of fancies and imaginations, is common to man and beast.",
    "To be violently drawn and moved by the lusts and desires of the soul, is proper to wild beasts and monsters, such as Phalaris and Nero were.",
    "To follow reason for ordinary duties and actions is common to them also, who believe not that there be any gods, and for their advantage would make no conscience to betray their own country; and who when once the doors be shut upon them, dare do anything.",
    ...
    "For what is it that thou art offended at?",
    "Can it be at the wickedness of men, when thou dost call to mind this conclusion, that all reasonable creatures are made one for another?",
    "and that it is part of justice to bear with them?",
    "and that it is against their wills that they offend?",
    "and how many already, who once likewise prosecuted their enmities, suspected, hated, and fiercely contended, are now long ago stretched out, and reduced unto ashes?",
    "It is time for thee to make an end.",
    ...
    "The next, that all these things, which now thou seest, shall within a very little while be changed, and be no more: and ever call to mind, how many changes and alterations in the world thou thyself hast already been an eyewitness of in thy time.",
    ...
    "Such and such things, from such and such causes, must of necessity proceed.",
    ...
    "If no man shall think himself wronged, then is there no more any such thing as wrong.",
    ...
    "These two rules, thou must have always in a readiness.",
    ...
    "Why then makest thou not use of it?",
    "For if thy reason do her part, what more canst thou require?",
    "As a part hitherto thou hast had a particular subsistence: and now shalt thou vanish away into the common substance of Him, who first begot thee, or rather thou shalt be resumed again into that original rational substance, out of which all others have issued, and are propagated.",
    "Many small pieces of frankincense are set upon the same altar, one drops first and is consumed, another after; and it comes all to one.",
    ...
    "Not as though thou hadst thousands of years to live.",
    "Death hangs over thee: whilst yet thou livest, whilst thou mayest, be good.",
    "Now much time and leisure doth he gain, who is not curious to know what his neighbour hath said, or hath done, or hath attempted, but only what he doth himself, that it may be just and holy?",
    "or to express it in Agathos' words, Not to look about upon the evil conditions of others, but to run on straight in the line, without any loose and extravagant agitation.",
    ...
    "But suppose that both they that shall remember thee, and thy memory with them should be immortal, what is that to thee?",
    "I will not say to thee after thou art dead; but even to thee living, what is thy praise?",
    "But only for a secret and politic consideration, which we call οἰκονομίαν, or dispensation.",
    "For as for that, that it is the gift of nature, whatsoever is commended in thee, what might be objected from thence, let that now that we are upon another consideration be omitted as unseasonable.",
    ...
    "This I understand even of those things, that are commonly called fair and good, as those which are commended either for the matter itself, or for curious workmanship.",
    "As for that which is truly good, what can it stand in need of more than either justice or truth; or more than either kindness and modesty?",
    ...
    "If so be that the souls remain after death (say they that will not believe it); how is the air from all eternity able to contain them?",
    "How is the earth (say I) ever from that time able to Contain the bodies of them that are buried?",
    ...
    "And here, (besides the number of bodies, so buried and contained by the earth), we may further consider the number of several beasts, eaten by us men, and by other creatures.",
    "For notwithstanding that such a multitude of them is daily consumed, and as it were buried in the bodies of the eaters, yet is the same place and body able to contain them, by reason of their conversion, partly into blood, partly into air and fire.",
    "What in these things is the speculation of truth?",
    "to divide things into that which is passive and material; and that which is active and formal.",
    ...
    "Whatsoever thy seasons bear, shall ever by me be esteemed as happy fruit, and increase.",
    "from thee are all things, in thee all things subsist, and to thee all tend.",
    "Could he say of Athens, Thou lovely city of Cecrops; and shalt not thou say of the world, Thou lovely city of God?",
    "They will say commonly, Meddle not with many things, if thou wilt live cheerfully.",
    ...
    "For since it is so, that most of those things, which we either speak or do, are unnecessary; if a man shall cut them off, it must needs follow that he shall thereby gain much leisure, and save much trouble, and therefore at every action a man must privately by way of admonition suggest unto himself, What?",
    "may not this that now I go about, be of the number of unnecessary actions?",
    ...
    "Either this world is a κόσμος or comely piece, because all disposed and governed by certain order: or if it be a mixture, though confused, yet still it is a comely piece.",
    "For is it possible that in thee there should be any beauty at all, and that in the whole world there should be nothing but disorder and confusion?",
    "and all things in it too, by natural different properties one from another differenced and distinguished; and yet all through diffused, and by natural sympathy, one to another united, as they are?",
    ...
    "For the same nature it is that brings this unto thee, whatsoever it be, that first brought thee into the world.",
    ...
    "There is, who without so much as a coat; and there is, who without so much as a book, doth put philosophy in practice.",
    "I am half naked, neither have I bread to eat, and yet I depart not from reason, saith one.",
    "But I say; I want the food of good teaching, and instructions, and yet I depart not from reason.",
    ...
    "And is not that their age quite over, and ended?",
    "Again, consider now the times of Trajan.",
    "There likewise thou seest the very self-same things, and that age also is now over and ended.",
    "In the like manner consider other periods, both of times and of whole nations, and see how many men, after they had with all their might and main intended and prosecuted some one worldly thing or other did soon after drop away, and were resolved into the elements.",
    ...
    "Camillus, Cæso, Volesius, Leonnatus; not long after, Scipio, Cato, then Augustus, then Adrianus, then Antoninus Pius: all these in a short time will be out of date, and, as things of another world as it were, become fabulous.",
    ...
    "And what is it then that shall always be remembered?",
    ...
    "Whatsoever is now present, and from day to day hath its existence; all objects of memories, and the minds and memories themselves, incessantly consider, all things that are, have their being by change and alteration.",
    "Use thyself therefore often to meditate upon this, that the nature of the universe delights in nothing more, than in altering those things that are, and in making others like unto them.",
    "So that we may say, that whatsoever is, is but as it were the seed of that which shall be.",
    "For if thou think that that only is seed, which either the earth or the womb receiveth, thou art very simple.",
    ...
    "In another man's mind and understanding thy evil Cannot subsist, nor in any proper temper or distemper of the natural constitution of thy body, which is but as it were the coat or cottage of thy soul.",
    ...
    "For as soon as anything hath appeared, and is passed away, another succeeds, and that also will presently out of sight.",
    ...
    "That, whatsoever it is, that comes after, doth always very naturally, and as it were familiarly, follow upon that which was before.",
    ...
    "Let that of Heraclitus never be out of thy mind, that the death of earth, is water, and the death of water, is air; and the death of air, is fire; and so on the contrary.",
    ...
    "Run them over also, whom thou thyself, one after another, hast known in thy time to drop away.",
    "Such and such a one took care of such and such a one's burial, and soon after was buried himself.",
    ...
    "That which but the other day when he was conceived was vile snivel; and within few days shall be either an embalmed carcass, or mere ashes.",
    ...
    "nay, happy I, to whom this thing being happened, I can continue without grief; neither wounded by that which is present, nor in fear of that which is to come.",
    ...
    "But however, canst thou, O man!",
    "term that unhappiness, which is no mischance to the nature of man I Canst thou think that a mischance to the nature of man, which is not contrary to the end and will of his nature?",
    "What then hast thou learned is the will of man's nature?",
    "Doth that then which hath happened unto thee, hinder thee from being just?",
    "or from anything else of all those things in the present enjoying and possession whereof the nature of man, (as then enjoying all that is proper unto her,) is fully satisfied?",
    ...
    "It is but an ordinary coarse one, yet it is a good effectual remedy against the fear of death, for a man to consider in his mind the examples of such, who greedily and covetously (as it were) did for a long time enjoy their lives.",
    "What have they got more, than they whose deaths have been untimely?",
    "Are not they themselves dead at the last?",
    "as Cadiciant's, Fabius, Julianus Lepidus, or any other who in their lifetime having buried many, were at the last buried themselves.",
    "The whole space of any man's life, is but little; and as little as it is, with what troubles, with what manner of dispositions, and in the society of how wretched a body must it be passed!",
    "Let it be therefore unto thee altogether as a matter of indifferency.",
    "For if thou shalt look backward; behold, what an infinite chaos of time doth present itself unto thee; and as infinite a chaos, if thou shalt look forward.",
    "In that which is so infinite, what difference can there be between that which liveth but three days, and that which liveth three ages?",
    "Let thy course ever be the most compendious way.",
    "The most compendious, is that which is according to nature: that is, in all both words and deeds, ever to follow that which is most sound and perfect.",
    ...
    "Or was I made for this, to lay me down, and make much of myself in a warm bed?",
    "'O but this is pleasing.' And was it then for this that thou wert born, that thou mightest enjoy pleasure?",
    ...
    "Others, as many as take pleasure in their trade and profession, can even pine themselves at their works, and neglect their bodies and their food for it; and doest thou less honour thy nature, than an ordinary mechanic his trade; or a good dancer his art?",
    ...
    "I continue my course by actions according to nature, until I fall and cease, breathing out my last breath into that air, by which continually breathed in I did live; and falling upon that earth, out of whose gifts and fruits my father gathered his seed, my mother her blood, and my nurse her milk, out of which for so many years I have been provided, both of meat and drink.",
    "And lastly, which beareth me that tread upon it, and beareth with me that so many ways do abuse it, or so freely make use of it, so many ways to so many ends.",
    "No man can admire thee for thy sharp acute language, such is thy natural disability that way.",
    "Be it so: yet there be many other good things, for the want of which thou canst not plead the want or natural ability.",
    ...
    "nay (witnesses be the Gods) of all these thou mightest have been rid long ago: only, this thou must have been contented with, to have borne the blame of one that is somewhat slow and dull, wherein thou must so exercise thyself, as one who neither doth much take to heart this his natural defect, nor yet pleaseth himself in it.",
    "Such there be, who when they have done a good turn to any, are ready to set them on the score for it, and to require retaliation.",
    ...
    "Others again there be, who when they have done any such thing, do not so much as know what they have done; but are like unto the vine, which beareth her grapes, and when once she hath borne her own proper fruit, is contented and seeks for no further recompense.",
    ...
    "'Nay but,' will some reply perchance, 'this very thing a rational man is bound unto, to understand what it is, that he doeth.' For it is the property, say they, of one that is naturally sociable, to be sensible, that he doth operate sociably: nay, and to desire, that the party him self that is sociably dealt with, should be sensible of it too.",
    "I answer, That which thou sayest is true indeed, but the true meaning of that which is said, thou dost not understand.",
    ...
    "What I now say, even they that are mere idiots are not ignorant of: for they say commonly τοῦτο ἔφερεν ἀυτῷ, that is, This his destiny hath brought upon him.",
    "This therefore is by the fates properly and particularly brought upon this, as that unto this in particular is by the physician prescribed.",
    "These therefore let us accept of in like manner, as we do those that are prescribed unto us our physicians.",
    "For them also in themselves shall We find to contain many harsh things, but we nevertheless, in hope of health, and recovery, accept of them.",
    "Let the fulfilling and accomplishment of those things which the common nature hath determined, be unto thee as thy health.",
    "Accept then, and be pleased with whatsoever doth happen, though otherwise harsh and un-pleasing, as tending to that end, to the health and welfare of the universe, and to Jove's happiness and prosperity.",
    ...
    "For the whole (because whole, therefore entire and perfect) is maimed, and mutilated, if thou shalt cut off anything at all, whereby the coherence, and contiguity as of parts, so of causes, is maintained and preserved.",
    "Of which certain it is, that thou doest (as much as lieth in thee) cut off, and in some sort violently take somewhat away, as often as thou art displeased with anything that happeneth.",
    ...
    "And remember that philosophy requireth nothing of thee, but what thy nature requireth, and wouldest thou thyself desire anything that is not according to nature?",
    "for which of these sayest thou; that which is according to nature or against it, is of itself more kind and pleasing?",
    ...
    "First, that nothing shall happen unto thee, which is not according to the nature of the universe.",
    "Secondly, that it is in thy power, to do nothing against thine own proper God, and inward spirit.",
    ...
    "Whose soul do I now properly possess?",
    ...
    "For why is it else, that this offends not and needs not to be excused, when virtues are styled good: but that which is spoken in commendation of wealth, pleasure, or honour, we entertain it only as merrily and pleasantly spoken?",
    ...
    "All that I consist of, is either form or matter.",
    "No corruption can reduce either of these unto nothing: for neither did I of nothing become a subsistent creature.",
    "Every part of mine then will by mutation be disposed into a certain part of the whole world, and that in time into another part; and so _in infinitum;_ by which kind of mutation, I also became what I am, and so did they that begot me, and they before them, and so upwards _in infinitum_.",
    "For so we may be allowed to speak, though the age and government of the world, be to some certain periods of time limited, and confined.",
    "Reason, and rational power, are faculties which content themselves with themselves, and their own proper operations.",
    "And as for their first inclination and motion, that they take from themselves.",
    ...
    "For which reason also such actions are termed κατορθώσεις, to intimate the directness of the way, by which they are achieved.",
    "Nothing must be thought to belong to a man, which doth not belong unto him as he is a man.",
    "These, the event of purposes, are not things required in a man.",
    "The nature of man doth not profess any such things.",
    "The final ends and consummations of actions are nothing at all to a man's nature.",
    "The end therefore of a man, or the _summum bonum_ whereby that end is fulfilled, cannot consist in the consummation of actions purposed and intended.",
    ...
    "For that we are made for society, it hath long since been demonstrated.",
    ...
    "and that those things that are best, are made one for another?",
    "And those things that have souls, are better than those that have none?",
    "and of those that have, those best that have rational souls?",
    "To desire things impossible is the part of a mad man.",
    "But it is a thing impossible, that wicked man should not commit some such things.",
    "Neither doth anything happen to any man, which in the ordinary course of nature as natural unto him doth not happen.",
    "Again, the same things happen unto others also.",
    ...
    "So also in thyself; honour that which is chiefest, and most powerful; and is of one kind and nature with that which we now spake of.",
    "For it is the very same, which being in thee, turneth all other things to its own use, and by whom also thy life is governed.",
    ...
    "consider rather what it is wherein he is overseen that is thought to have done the wrong.",
    ...
    "Next unto this, and which follows upon it, consider both the infiniteness of the time already past, and the immense vastness of that which is to come, wherein all things are to be resolved and annihilated.",
    "Art not thou then a very fool, who for these things, art either puffed up with pride, or distracted with cares, or canst find in thy heart to make such moans as for a thing that would trouble thee for a very long time?",
    ...
    "Again: another doth trespass against me.",
    "He is master of his own disposition, and of his own operation.",
    "I for my part am in the meantime in possession of as much, as the common nature would have me to possess: and that which mine own nature would have me do, I do.",
    ...
    "But if at any time they do reflect and rebound upon the mind and understanding (as in an united and compacted body it must needs;) then must thou not go about to resist sense and feeling, it being natural.",
    ...
    "Be not angry neither with him whose breath, neither with him whose arm holes, are offensive.",
    "such is his breath naturally, and such are his arm holes; and from such, such an effect, and such a smell must of necessity proceed.",
    "'O, but the man (sayest thou) hath understanding in him, and might of himself know, that he by standing near, cannot choose but offend.' And thou also (God bless thee!) hast understanding.",
    "Let thy reasonable faculty, work upon his reasonable faculty; show him his fault, admonish him.",
    "If he hearken unto thee, thou hast cured him, and there will be no more occasion of anger.",
    "'Where there shall neither roarer be, nor harlot.' Why so?",
    ...
    "And what a great matter is this!",
    "Now till some such thing force me out, I will continue free; neither shall any man hinder me to do what I will, and my will shall ever be by the proper nature of a reasonable and sociable creature, regulated and directed.",
    ...
    "Seest thou not how it hath sub-ordinated, and co-ordinated?",
    "and how it hath distributed unto everything according to its worth?",
    "and those which have the pre-eminency and superiority above all, hath it united together, into a mutual consent and agreement.",
    "How hast thou carried thyself hitherto towards the Gods?",
    "Is it so with thee, that hitherto thou hast neither by word or deed wronged any of them?",
    "Remember withal through how many things thou hast already passed, and how many thou hast been able to endure; so that now the legend of thy life is full, and thy charge is accomplished.",
    "Again, how many truly good things have certainly by thee been discerned?",
    "how many pleasures, how many pains hast thou passed over with contempt?",
    "how many things eternally glorious hast thou despised?",
    "towards how many perverse unreasonable men hast thou carried thyself kindly, and discreetly?",
    "Why should imprudent unlearned souls trouble that which is both learned, and prudent?",
    "she that understandeth the beginning and the end, and hath the true knowledge of that rational essence, that passeth through all things subsisting, and through all ages being ever the same, disposing and dispensing as it were this universe by certain periods of time.",
    ...
    "And what is that but an empty sound, and a rebounding echo?",
    ...
    "The most weighty and serious, if rightly esteemed, but as puppies, biting one another: or untoward children, now laughing and then crying.",
    "As for faith, and modesty, and justice, and truth, they long since, as one of the poets hath it, have abandoned this spacious earth, and retired themselves unto heaven.",
    "What is it then that doth keep thee here, if things sensible be so mutable and unsettled?",
    "and the senses so obscure, and so fallible?",
    ...
    "an extinction, or a translation; either of them with a propitious and contented mind.",
    "But still that time come, what will content thee?",
    "what else, but to worship and praise the Gods; and to do good unto men.",
    "To bear with them, and to forbear to do them any wrong.",
    "And for all external things belonging either to this thy wretched body, or life, to remember that they are neither thine, nor in thy power.",
    "Thou mayest always speed, if thou wilt but make choice of the right way; if in the course both of thine opinions and actions, thou wilt observe a true method.",
    ...
    "If this neither be my wicked act, nor an act anyways depending from any wickedness of mine, and that by it the public is not hurt; what doth it concern me?",
    "And wherein can the public be hurt?",
    ...
    "For indeed what is all this pleading and public bawling for at the courts?",
    "O man, hast thou forgotten what those things are!",
    "yea but they are things that others much care for, and highly esteem of.",
    "Wilt thou therefore be a fool too?",
    ...
    "All substances come soon to their change, and either they shall be resolved by way of exhalation (if so be that all things shall be reunited into one substance), or as others maintain, they shall be scattered and dispersed.",
    ...
    "Either this universe is a mere confused mass, and an intricate context of things, which shall in time be scattered and dispersed again: or it is an union consisting of order, and administered by Providence.",
    "If the first, why should I desire to continue any longer in this fortuit confusion and commixtion?",
    "or why should I take care for anything else, but that as soon as may be I may be earth again?",
    "And why should I trouble myself any more whilst I seek to please the Gods?",
    "Whatsoever I do, dispersion is my end, and will come upon me whether I will or no.",
    "But if the latter be, then am not I religious in vain; then will I be quiet and patient, and put my trust in Him, who is the Governor of all.",
    ...
    "So let the court and thy philosophy be unto thee.",
    ...
    "How marvellous useful it is for a man to represent unto himself meats, and all such things that are for the mouth, under a right apprehension and imagination!",
    "as for example: This is the carcass of a fish; this of a bird; and this of a hog.",
    "And again more generally; This phalernum, this excellent highly commended wine, is but the bare juice of an ordinary grape.",
    ...
    "And even whatsoever now is, some part thereof hath already perished.",
    ...
    "as if a man would settle his affection upon some ordinary sparrow living by him, who is no sooner seen, than out of sight.",
    ...
    "What is it then that should be dear unto us?",
    ...
    "If then neither applause, what is there remaining that should be dear unto thee?",
    ...
    "For it is that which every art doth aim at, that whatsoever it is, that is by art effected and prepared, may be fit for that work that it is prepared for.",
    ...
    "What else doth the education of children, and all learned professions tend unto?",
    "Certainly then it is that, which should be dear unto us also.",
    "If in this particular it go well with thee, care not for the obtaining of other things.",
    "But is it so, that thou canst not but respect other things also?",
    "Then canst not thou truly be free?",
    "then canst thou not have self-content: then wilt thou ever be subject to passions.",
    "For it is not possible, but that thou must be envious, and jealous, and suspicious of them whom thou knowest can bereave thee of such things; and again, a secret underminer of them, whom thou seest in present possession of that which is dear unto thee.",
    "To be short, he must of necessity be full of confusion within himself, and often accuse the Gods, whosoever stands in need of these things.",
    ...
    "Who can choose but wonder at them?",
    "They will not speak well of them that are at the same time with them, and live with them; yet they themselves are very ambitious, that they that shall follow, whom they have never seen, nor shall ever see, should speak well of them.",
    "As if a man should grieve that he hath not been commended by them, that lived before him.",
    ...
    "Thou dost not suspect him for it afterwards, as one that watcheth to do thee a mischief.",
    ...
    "For as I said, it is very possible for us to avoid and decline, though we neither suspect, nor hate.",
    ...
    "For as for those creatures which are not endued with reason and all other things and-matters of the world whatsoever I freely, and generously, as one endued with reason, of things that have none, make use of them.",
    "And as for men, towards them as naturally partakers of the same reason, my care is to carry myself sociably.",
    "But whatsoever it is that thou art about, remember to call upon the Gods.",
    ...
    "if any should put this question unto thee, how this word Antoninus is written, wouldst thou not presently fix thine intention upon it, and utter out in order every letter of it?",
    "And if any shall begin to gainsay thee, and quarrel with thee about it; wilt thou quarrel with him again, or rather go on meekly as thou hast begun, until thou hast numbered out every letter?",
    ...
    "For surely they are led unto those sins whatsoever they be, as to their proper good and commodity.",
    "But it is not so (thou wilt object perchance).",
    "Thou therefore teach them better, and make it appear unto them: but be not thou angry with them.",
    ...
    "If in this kind of life thy body be able to hold out, it is a shame that thy soul should faint first, and give over, take heed, lest of a philosopher thou become a mere Cæsar in time, and receive a new tincture from the court.",
    "For it may happen if thou dost not take heed.",
    ...
    "How able to endure labour, how patient; able through his spare diet to continue from morning to evening without any necessity of withdrawing before his accustomed hours to the necessities of nature: his uniformity and constancy in matter of friendship.",
    "How he would bear with them that with all boldness and liberty opposed his opinions; and even rejoice if any man could better advise him: and lastly, how religious he was without superstition.",
    ...
    "As long as the foot doth that which belongeth unto it to do, and the hand that which belongs unto it, their labour, whatsoever it be, is not unnatural.",
    "So a man as long as he doth that which is proper unto a man, his labour cannot be against nature; and if it be not against nature, then neither is it hurtful unto him.",
    ...
    "Asia, Europe; what are they, but as corners of the whole world; of which the whole sea, is but as one drop; and the great Mount Athos, but as a clod, as all present time is but as one point of eternity.",
    "All, petty things; all things that are soon altered, soon perished.",
    "And all things come from one beginning; either all severally and particularly deliberated and resolved upon, by the general ruler and governor of all; or all by necessary consequence.",
    ...
    "Think not of these therefore, as things contrary to those which thou dost much honour, and respect; but consider in thy mind the true fountain of all.",
    "XXXIV He that seeth the things that are now, hath Seen all that either was ever, or ever shall be, for all things are of one kind; and all like one unto another.",
    ...
    "As I think Heraclitus in a place speaketh of them that sleep, that even they do work in their kind, and do confer to the general operations of the world.",
    ...
    "For as for him who is the Administrator of all, he will make good use of thee whether thou wilt or no, and make thee (as a part and member of the whole) so to co-operate with him, that whatsoever thou doest, shall turn to the furtherance of his own counsels, and resolutions.",
    ...
    "Doth either the sun take upon him to do that which belongs to the rain?",
    "or his son Aesculapius that, which unto the earth doth properly belong?",
    "How is it with every one of the stars in particular?",
    ...
    "But yet this also shalt thou generally perceive, if thou dost diligently take heed, that whatsoever doth happen to any one man or men....",
    ...
    "As the ordinary shows of the theatre and of other such places, when thou art presented with them, affect thee; as the same things still seen, and in the same fashion, make the sight ingrateful and tedious; so must all the things that we see all our life long affect us.",
    "For all things, above and below, are still the same, and from the same causes.",
    ...
    "so that thou mayst even come down to Philistio, Phœbus, and Origanion.",
    "Pass now to other generations.",
    "Thither shall we after many changes, where so many brave orators are; where so many grave philosophers; Heraclitus, Pythagoras, Socrates.",
    "Where so many heroes of the old times; and then so many brave captains of the latter times; and so many kings.",
    ...
    "And what do they suffer by it!",
    "Nay they that have not so much as a name remaining, what are they the worse for it?",
    ...
    "Dost thou grieve that thou dost weigh but so many pounds, and not three hundred rather?",
    ...
    "And this thou hast, and mayst always obtain, whether the thing desired be in thy power or no.",
    ...
    "Will either passengers, or patients, find fault and complain, either the one if they be well carried, or the others if well cured?",
    "Do they take care for any more than this; the one, that their shipmaster may bring them safe to land, and the other, that their physician may effect their recovery?",
    "How many of them who came into the world at the same time when I did, are already gone out of it?",
    "To them that are sick of the jaundice, honey seems bitter; and to them that are bitten by a mad dog, the water terrible; and to children, a little ball seems a fine thing.",
    "And why then should I be angry?",
    ...
    "Nothing can happen unto thee, but what the common good of nature doth require.",
    ...
    "The very same things whereof ancient stories, middle age stories, and fresh stories are full whereof towns are full, and houses full.",
    ...
    "If it be, why then am I troubled?",
    ...
    "That which most men would think themselves most happy for, and would prefer before all things, if the Gods would grant it unto them after their deaths, thou mayst whilst thou livest grant unto thyself; to live again.",
    "See the things of the world again, as thou hast already seen them.",
    "For what is it else to live again?",
    ...
    "And as in matter of purposes and actions, we must presently see what is the proper use and relation of every one; so of words must we be as ready, to consider of every one what is the true meaning, and signification of it according to truth and nature, however it be taken in common use.",
    "Is my reason, and understanding sufficient for this, or no?",
    "If it be sufficient, without any private applause, or public ostentation as of an instrument, which by nature I am provided of, I will make use of it for the work in hand, as of an instrument, which by nature I am provided of.",
    "if it be not, and that otherwise it belong not unto me particularly as a private duty, I will either give it over, and leave it to some other that can better effect it: or I will endeavour it; but with the help of some other, who with the joint help of my reason, is able to bring somewhat to pass, that will now be seasonable and useful for the common good.",
    ...
    "For whatsoever it be that lieth upon thee to effect, thou must propose it unto thyself, as the scaling of walls is unto a soldier.",
    ...
    "For if necessity so require that they come to pass, thou shalt (whensoever that is) be provided for them with the same reason, by which whatsoever is now present, is made both tolerable and acceptable unto thee.",
    ...
    "For all things are ranked together, and by that decency of its due place and order that each particular doth observe, they all concur together to the making of one and the same κόσμος or world: as if you said, a comely piece, or an orderly composition.",
    ...
    "And this thou shalt apprehend the better, if thou shalt use thyself often to say to thyself, I am μέλος, or a member of the mass and body of reasonable substances.",
    "But if thou shalt say I am μέρος, or a part, thou dost not yet love men from thy heart.",
    "The joy that thou takest in the exercise of bounty, is not yet grounded upon a due ratiocination and right apprehension of the nature of things.",
    "Thou dost exercise it as yet upon this ground barely, as a thing convenient and fitting; not, as doing good to thyself, when thou dost good unto others.",
    "Of things that are external, happen what will to that which can suffer by external accidents.",
    "Those things that suffer let them complain themselves, if they will; as for me, as long as I conceive no such thing, that that which is happened is evil, I have no hurt; and it is in my power not to conceive any such thing.",
    ...
    "If it be in the power of any other to compel it to fear, or to grieve, it is free for him to use his power.",
    ...
    "For as for the body, why should I make the grief of my body, to be the grief of my mind?",
    ...
    "The understanding is of itself sufficient unto itself, and needs not (if itself doth not bring itself to need) any other thing besides itself, and by consequent as it needs nothing, so neither can it be troubled or hindered by anything, if itself doth not trouble and hinder itself.",
    "What is εὐδαιμονία, or happiness: but ἀγαθὸς δαίμων, or, a good dæmon, or spirit?",
    "What then dost thou do here, O opinion?",
    "By the Gods I adjure thee, that thou get thee gone, as thou earnest: for I need thee not.",
    "Thou earnest indeed unto me according to thy ancient wonted manner.",
    "It is that, that all men have ever been subject unto.",
    ...
    "Let this, be it either men or businesses, that thou hast occasion to think of, to the end that thy thoughts be not distracted and thy mind too earnestly set upon anything, upon every such occasion presently come to thy mind.",
    "Of all my thoughts and cares, one only thing shall be the object, that I myself do nothing which to the proper constitution of man, (either in regard of the thing itself, or in regard of the manner, or of the time of doing,) is contrary.",
    "The time when thou shalt have forgotten all things, is at hand.",
    "And that time also is at hand, when thou thyself shalt be forgotten by all.",
    "Whilst thou art, apply thyself to that especially which unto man as he is a mart, is most proper and agreeable, and that is, for a man even to love them that transgress against him.",
    "This shall be, if at the same time that any such thing doth happen, thou call to mind, that they are thy kinsmen; that it is through ignorance and against their wills that they sin; and that within a very short while after, both thou and he shall be no more.",
    "But above all things, that he hath not done thee any hurt; for that by him thy mind and understanding is not made worse or more vile than it was before.",
    ...
    "For either thou thyself dust yet live in that error and ignorance, as that thou dust suppose either that very thing that he doth, or some other like worldly thing, to be good; and so thou art bound to pardon him if he have done that which thou in the like case wouldst have done thyself.",
    "Or if so be that thou dost not any more suppose the same things to be good or evil, that he doth; how canst thou but be gentle unto him that is in an error?",
    ...
    "Wipe off all opinion stay the force and violence of unreasonable lusts and affections: circumscribe the present time examine whatsoever it be that is happened, either to thyself or to another: divide all present objects, either in that which is formal or material think of the last hour.",
    "That which thy neighbour hath committed, where the guilt of it lieth, there let it rest.",
    "Examine in order whatsoever is spoken.",
    ...
    "Finally, love mankind; obey God.",
    "All things (saith he) are by certain order and appointment.",
    ...
    "Thy understanding is not made worse by it.",
    "As for those parts that suffer, let them, if they can, declare their grief themselves.",
    ...
    "'He then whose mind is endowed with true magnanimity, who hath accustomed himself to the contemplation both of all times, and of all things in general; can this mortal life (thinkest thou) seem any great matter unto him?",
    "It is not possible, answered he.",
    "Then neither will such a one account death a grievous thing?",
    "'It is a princely thing to do well, and to be ill-spoken of.",
    "It is a shameful thing that the face should be subject unto the mind, to be put into what shape it will, and to be dressed by it as it will; and that the mind should not bestow so much care upon herself, as to fashion herself, and to dress herself as best becometh her.' XXV.",
    ...
    "For as for them, they are not sensible of it, &c.",
    "Thou shalt but make thyself a laughing-stock; both unto the Gods and men, &c.",
    "Our life is reaped like a ripe ear of corn; one is yet standing and another is down, &c.",
    "But if so be that I and my children be neglected by the gods, there is some reason even for that, &c.",
    "As long as right and equity is of my side, &c.",
    "Not to lament with them, not to tremble, &c.' XXVI.",
    "'My answer, full of justice and equity, should be this: Thy speech is not right, O man!",
    "if thou supposest that he that is of any worth at all, should apprehend either life or death, as a matter of great hazard and danger; and should not make this rather his only care, to examine his own actions, whether just or unjust: whether actions of a good, or of a wicked man, &c.",
    "For thus in very truth stands the case, O ye men of Athens.",
    "What place or station soever a man either hath chosen to himself, judging it best for himself; or is by lawful authority put and settled in, therein do I think (all appearance of danger notwithstanding) that he should continue, as one who feareth neither death, nor anything else, so much as he feareth to commit anything that is vicious and shameful, &c.",
    ...
    "We may also foresee things future, for they shall all be of the same kind; neither is it possible that they should leave the tune, or break the concert that is now begun, as it were, by these things that are now done and brought to pass in the world.",
    "It comes all to one therefore, whether a man be a spectator of the things of this life but forty years, or whether he see them ten thousand years together: for what shall he see more?",
    ...
    "'With meats and drinks and divers charms, they seek to divert the channel, that they might not die.",
    "Yet must we needs endure that blast of wind that cometh from above, though we toil and labour never so much.' XXVIII.",
    ...
    "Where the matter may be effected agreeably to that reason, which both unto the Gods and men is common, there can be no just cause of grief or sorrow.",
    "For where the fruit and benefit of an action well begun and prosecuted according to the proper constitution of man may be reaped and obtained, or is sure and certain, it is against reason that any damage should there be suspected.",
    ...
    "And therefore over both she challengeth mastery, and cannot anyways endure, if in her right temper, to be subject unto either.",
    ...
    "They grieved; they wondered; they complained.",
    "Wilt thou also be like one of them?",
    ...
    "For in this they both agree, to teach a man whatsoever falls upon him, that he may be ready for it, and that nothing may cast him down.",
    ...
    "'No soul (saith he) is willingly bereft of the truth,' and by consequent, neither of justice, or temperance, or kindness, and mildness; nor of anything that is of the same kind.",
    ...
    "For that he died more gloriously, that he disputed with the Sophists more subtilty; that he watched in the frost more assiduously; that being commanded to fetch innocent Salaminius, he refused to do it more generously; all this will not serve.",
    ...
    "The thing therefore that we must inquire into, is this; what manner of soul Socrates had: whether his disposition was such; as that all that he stood upon, and sought after in this world, was barely this, that he might ever carry himself justly towards men, and holily towards the Gods.",
    "Neither vexing himself to no purpose at the wickedness of others, nor yet ever condescending to any man's evil fact, or evil intentions, through either fear, or engagement of friendship.",
    "Whether of those things that happened unto him by God's appointment, he neither did wonder at any when it did happen, or thought it intolerable in the trial of it.",
    "And lastly, whether he never did suffer his mind to sympathise with the senses, and affections of the body.",
    "For we must not think that Nature hath so mixed and tempered it with the body, as that she hath not power to circumscribe herself, and by herself to intend her own ends and occasions.",
    ...
    "And that which is principal in this matter, is that it may be referred either unto the praise of God, or to the good of men.",
    ...
    "Now since that time, whatsoever it is, that is and happens in the world, is either but a consequent of that one and first deliberation: or if so be that this ruling rational part of the world, takes any thought and care of things particular, they are surely his reasonable and principal creatures, that are the proper object of his particular care and providence.",
    "This often thought upon, will much conduce to thy tranquillity.",
    "This also, among other things, may serve to keep thee from vainglory; if thou shalt consider, that thou art now altogether incapable of the commendation of one, who all his life long, or from his youth at least, hath lived a philosopher's life.",
    ...
    "Thou hast already had sufficient experience, that of those many things that hitherto thou hast erred and wandered about, thou couldst not find happiness in any of them.",
    "Not in syllogisms, and logical subtilties, not in wealth, not in honour and reputation, not in pleasure.",
    "Wherein then is it to be found?",
    "In the practice of those things, which the nature of man, as he is a man, doth require.",
    "How then shall he do those things?",
    "if his dogmata, or moral tenets and opinions (from which all motions and actions do proceed), be right and true.",
    ...
    "Shall I have no occasion to repent of it?",
    ...
    "These penetrated into the true nature of things; into all causes, and all subjects: and upon these did they exercise their power and authority.",
    "But as for those, as the extent of their error was, so far did their slavery extend.",
    "What they have done, they will still do, although thou shouldst hang thyself.",
    "First; let it not trouble thee.",
    "For all things both good and evil: come to pass according to the nature and general condition of the universe, and within a very little while, all things will be at an end; no man will be remembered: as now of Africanus (for example) and Augustus it is already come to pass.",
    "Then secondly; fix thy mind upon the thing itself; look into it, and remembering thyself, that thou art bound nevertheless to be a good man, and what it is that thy nature requireth of thee as thou art a man, be not diverted from what thou art about, and speak that which seemeth unto thee most just: only speak it kindly, modestly, and without hypocrisy.",
    ...
    "So that thou needest not fear any new thing.",
    "For all things are usual and ordinary; and all things are disposed by equality.",
    "Every particular nature hath content, when in its own proper course it speeds.",
    ...
    "Secondly, when in all its motions and resolutions it takes its level at the common good only, and that it desireth nothing, and flieth from nothing, bet what is in its own power to compass or avoid.",
    "And lastly, when it willingly and gladly embraceth, whatsoever is dealt and appointed unto it by the common nature.",
    "For it is part of it; even as the nature of any one leaf, is part of the common nature of all plants and trees.",
    "But that the nature of a leaf, is part of a nature both unreasonable and unsensible, and which in its proper end may be hindered; or, which is servile and slavish: whereas the nature of man is part of a common nature which cannot be hindered, and which is both reasonable and just.",
    "From whence also it is, that according to the worth of everything, she doth make such equal distribution of all things, as of duration, substance form, operation, and of events and accidents.",
    "But herein consider not whether thou shalt find this equality in everything absolutely and by itself; but whether in all the particulars of some one thing taken together, and compared with all the particulars of some other thing, and them together likewise.",
    ...
    "Repentance is an inward and self-reprehension for the neglect or omission of somewhat that was profitable.",
    "Now whatsoever is good, is also profitable, and it is the part of an honest virtuous man to set by it, and to make reckoning of it accordingly.",
    ...
    "And what more proper and natural, yea what more kind and pleasing, than that which is according to nature?",
    ...
    "as concerning pain, pleasure, and the causes of both; concerning honour, and dishonour, concerning life and death?",
    "Now if it be no wonder that a man should have such and such opinions, how can it be a wonder that he should do such and such things?",
    "I will remember then, that he cannot but do as he doth, holding those opinions that he doth.",
    "Remember, that as it is a shame for any man to wonder that a fig tree should bear figs, so also to wonder that the world should bear anything, whatsoever it is which in the ordinary course of nature it may bear.",
    ...
    "For of thee nothing is required, ti, is beyond the extent of thine own deliberation and jun.",
    "merit, and of thine own understanding.",
    "If it were thine act and in thine own power, wouldest thou do it?",
    "If it were not, whom dost tin accuse?",
    "For to do either, the part of a mad man.",
    ...
    "The same are the world's elements, and the elements of which thou dost consist.",
    "And they when they are changed, they murmur not; why shouldest thou?",
    "Whatsoever is, was made for something: as a horse, a vine.",
    "The sun itself will say of itself, I was made for something; and so hath every god its proper function.",
    "to disport and delight thyself?",
    ...
    "As one that tosseth up a ball.",
    "And what is a ball the better, if the motion of it be upwards; or the worse if it be downwards; or if it chance to fall upon the ground?",
    "So for the bubble; if it continue, what it the better?",
    "and if it dissolve, what is it the worse And so is it of a candle too.",
    "And so must thou reason with thyself, both in matter of fame, and in matter of death.",
    "For as for the body itself, (the subject of death) wouldest thou know the vileness of it?",
    "Turn it about that thou mayest behold it the worst sides upwards as well, as in its more ordinary pleasant shape; how doth it look, when it is old and withered?",
    "when in the act of lust, and fornication?",
    "Both he that praiseth, and he that is praised; he that remembers, and he that is remembered, will soon be dust and ashes.",
    "Besides, it is but in one corner of this part of the world that thou art praised; and yet in this corner, thou hast not the joint praises of all men; no nor scarce of any one constantly.",
    "And yet the whole earth itself, what is it but as one point, in regard of the whole world?",
    ...
    "O but thou hadst rather become good to-morrow, than to be so to-day.",
    "I will; so the end of my action be to do good unto men.",
    "Doth anything by way of cross or adversity happen unto me?",
    "I accept it, with reference unto the Gods, and their providence; the fountain of all things, from which whatsoever comes to pass, doth hang and depend.",
    ...
    "So Secunda Maximus, then Secunda herself.",
    "So Epitynchanus, Diotimus; then Epitynchanus himself.",
    "So Antoninus Pius, Faustina his wife; then Antoninus himself.",
    "This is the course of the world.",
    "First Celer, Adrianus; then Adrianus himself.",
    ...
    "They were all but for one day; all dead and gone long since.",
    "Some of them no sooner dead, than forgotten.",
    "Others soon turned into fables.",
    "Of others, even that which was fabulous, is now long since forgotten.",
    "This thereafter thou must remember, that whatsoever thou art compounded of, shall soon be dispersed, and that thy life and breath, or thy soul, shall either be no more or shall ranslated (sp.), and appointed to some certain place and station.",
    ...
    "The Second to the first original cause, God, from whom originally proceeds whatsoever doth happen in the world.",
    ...
    "Whether thou speak in the Senate or whether thou speak to any particular, let thy speech In always grave and modest.",
    "But thou must not openly and vulgarly observe that sound and exact form of speaking, concerning that which is truly good and truly civil; the vanity of the world, and of worldly men: which otherwise truth and reason doth prescribe.",
    "Augustus his court; his wife, his daughter, his nephews, his sons-in-law his sister, Agrippa, his kinsmen, his domestics, his friends; Areus, Mæcenas, his slayers of beasts for sacrifice and divination: there thou hast the death of a whole court together.",
    ...
    "O what care did his predecessors take, that they might leave a successor, yet behold at last one or other must of necessity be THE LAST.",
    "Here again therefore consider the death of a whole kindred.",
    "Contract thy whole life to the measure and proportion of one single action.",
    "And if in every particular action thou dost perform what is fitting to the utmost of thy power, let it suffice thee.",
    ...
    "Whosoever thou art, thou art such, thou art cast forth I know not whither out of the general unity, which is according to nature.",
    "Thou went born indeed a part, but now thou hast cut thyself off.",
    "However, herein is matter of joy and exultation, that thou mayst be united again.",
    "God hath not granted it unto any other part, that once separated and cut off, it might be reunited, and come together again.",
    "But, behold, that GOODNESS how great and immense it is!",
    "which hath so much esteemed MAN.",
    ...
    "(And that also is much lessened, if thou dost lightly circumscribe it:) and then check thy mind if for so little a while, (a mere instant), it cannot hold out with patience.",
    "are either Panthea or Pergamus abiding to this day by their masters' tombs?",
    "or either Chabrias or Diotimus by that of Adrianus?",
    "For what if they did, would their masters be sensible of It?",
    "or if sensible, would they be glad of it?",
    "or if glad, were these immortal?",
    "Was not it appointed unto them also (both men and women,) to become old in time, and then to die?",
    ...
    "'Yea, but I am not reason.' Well, be it so.",
    ...
    "If thou didst propose without due reservation and exception now hath thy reasonable part received a blow indeed But if in general thou didst propose unto thyself what soever might be, thou art not thereby either hurt, nor properly hindered.",
    ...
    "Why should I grieve myself; who never did willingly grieve any other!",
    "One thing rejoices one and another thing another.",
    ...
    "This time that is now present, bestow thou upon thyself.",
    ...
    "And besides they also will be mortal men.",
    ...
    "as either basely dejected, or disordinately affected, or confounded within itself, or terrified?",
    ...
    "'Yea but it is a thing of that nature, as that thy life is not worth the while, except it may be performed.' If it be so, upon condition that thou be kindly and lovingly disposed towards all men, thou mayest be gone.",
    "For even then, as much as at any time, art thou in a very good estate of performance, when thou doest die in charity with those, that are an obstacle unto thy performance.",
    ...
    "He that seeth not this is unlearned.",
    "He that seeth it, and betaketh not himself to this place of refuge, is unhappy.",
    ...
    "That he is sick, I see, but that he is in danger of his life also, I see it not.",
    ...
    "Add not presently speaking unto thyself, What serve these things for in the world?",
    "For, this, one that is acquainted with the mysteries of nature, will laugh at thee for it; as a carpenter would or a shoemaker, if meeting in either of their shops with some shavings, or small remnants of their work, thou shouldest blame them for it.",
    ...
    "Not basely to contract thy soul; nor boisterously to sally out with it, or furiously to launch out as it were, nor ever to want employment.",
    "'They kill me, they cut my flesh; they persecute my person with curses.' What then?",
    "May not thy mind for all this continue pure, prudent, temperate, just?",
    "As a fountain of sweet and clear water, though she be cursed by some stander by, yet do her springs nevertheless still run as sweet and clear as before; yea though either dirt or dung be thrown in, yet is it no sooner thrown, than dispersed, and she cleared.",
    ...
    "He that knoweth not what the world is, knoweth not where he himself is.",
    "And he that knoweth not what the world was made for, cannot possibly know either what are the qualities, or what is the nature of the world.",
    "Now he that in either of these is to seek, for what he himself was made is ignorant also.",
    "What then dost thou think of that man, who proposeth unto himself, as a matter of great moment, the noise and applause of men, who both where they are, and what they are themselves, are altogether ignorant?",
    "Dost thou desire to be commended of that man, who thrice in one hour perchance, doth himself curse himself?",
    "Dost thou desire to please him, who pleaseth not himself?",
    "or dost thou think that he pleaseth himself, who doth use to repent himself almost of everything that he doth?",
    ...
    "Wickedness in general doth not hurt the world.",
    ...
    "For though we are all made one for another, yet have our minds and understandings each of them their own proper and limited jurisdiction.",
    ...
    "The sun seemeth to be shed abroad.",
    "And indeed it is diffused but not effused.",
    "For that diffusion of it is a τάσις or an extension.",
    "For therefore are the beams of it called ἀκτῖνες from the word ἐκτείνεσθαι to be stretched out and extended.",
    ...
    "For it is always in a direct line.",
    ...
    "What obstacles and impediments soever she meeteth within her way, she must not violently, and by way of an impetuous onset light upon them; neither must she fall down; but she must stand, and give light unto that which doth admit of it.",
    "For as for that which doth not, it is its own fault and loss, if it bereave itself of her light.",
    "He that feareth death, either feareth that he shall have no sense at all, or that his senses will not be the same.",
    "Whereas, he should rather comfort himself, that either no sense at all, and so no sense of evil; or if any sense, then another life, and so no death properly.",
    ...
    "He that is unjust, is also impious.",
    ...
    "And that we have already showed to be impious.",
    ...
    "But now, what a toil it is for thee to live with men of different opinions, thou seest: so that thou hast rather occasion to say, Hasten, I thee pray, O Death; lest I also in time forget myself.",
    ...
    "And whatsoever is airy, would be together likewise.",
    ...
    "As for unreasonable creatures then, they had not long been, but presently begun among them swarms, and flocks, and broods of young ones, and a kind of mutual love and affection.",
    "For though but unreasonable, yet a kind of soul these had, and therefore was that natural desire of union more strong and intense in them, as in creatures of a more excellent nature, than either in plants, or stones, or trees.",
    ...
    "So proper is it to excellency in a high degree to affect unity, as that even in things so far distant, it could operate unto a mutual sympathy.",
    "But now behold, what is now come to pass.",
    ...
    "Do they what they can, nature doth prevail.",
    ...
    "All things have their proper time to bear.",
    "Though by custom, the word itself is in a manner become proper unto the vine, and the like, yet is it so nevertheless, as we have said.",
    "As for reason, that beareth both common fruit for the use of others; and peculiar, which itself doth enjoy.",
    ...
    "And mightest thou not be so too?",
    "or, tell me, what doth hinder thee?",
    ...
    "This day I did come out of all my trouble.",
    "Nay I have cast out all my trouble; it should rather be for that which troubled thee, whatsoever it was, was not without anywhere that thou shouldest come out of it, but within in thine own opinions, from whence it must be cast out, before thou canst truly and constantly be at ease.",
    ...
    "As they were in the days of those whom we have buried, so are they now also, and no otherwise.",
    "The things themselves that affect us, they stand without doors, neither knowing anything themselves nor able to utter anything unto others concerning themselves.",
    "What then is it, that passeth verdict on them?",
    ...
    "it is not thine, but another man's sin.",
    ...
    "Apply this now to a man's age, as first, a child; then a youth, then a young man, then an old man; every change from one age to another is a kind of death And all this while here no matter of grief yet.",
    "Pass now unto that life first, that which thou livedst under thy grandfather, then under thy mother, then under thy father.",
    "And thus when through the whole course of thy life hitherto thou hast found and observed many alterations, many changes, many kinds of endings and cessations, put this question to thyself What matter of grief or sorrow dost thou find in any of these?",
    "Or what doest thou suffer through any of these?",
    ...
    "As occasion shall require, either to thine own understanding, or to that of the universe, or to his, whom thou hast now to do with, let thy refuge be with all speed.",
    ...
    "Of his, that thou mayest consider whether in the estate of ignorance, or of knowledge.",
    "And then also must thou call to mind, that he is thy kinsman.",
    "As thou thyself, whoever thou art, were made for the perfection and consummation, being a member of it, of a common society; so must every action of thine tend to the perfection and consummation of a life that is truly sociable.",
    ...
    "Go to the quality of the cause from which the effect doth proceed.",
    "Behold it by itself bare and naked, separated from all that is material.",
    ...
    "Thou shalt see, that there is no such occasion why it should trouble thee, what such as they are think of thee.",
    "Yet must thou love them still, for by nature they are thy friends.",
    "And the Gods themselves, in those things that they seek from them as matters of great moment, are well content, all manner of ways, as by dreams and oracles, to help them as well as others.",
    "Up and down, from one age to another, go the ordinary things of the world; being still the same.",
    "And either of everything in particular before it come to pass, the mind of the universe doth consider with itself and deliberate: and if so, then submit for shame unto the determination of such an excellent understanding: or once for all it did resolve upon all things in general; and since that whatsoever happens, happens by a necessary consequence, and all things indivisibly in a manner and inseparably hold one of another.",
    "In sum, either there is a God, and then all is well; or if all things go by chance and fortune, yet mayest thou use thine own providence in those things that concern thee properly; and then art thou well.",
    "Within a while the earth shall cover us all, and then she herself shall have her change.",
    ...
    "Do what thy nature doth now require.",
    ...
    "If they profit though never so little, I must be content; and think much even of that little progress.",
    "Doth then any of them forsake their former false opinions that I should think they profit?",
    "For without a change of opinions, alas!",
    "what is all that ostentation, but mere wretchedness of slavish minds, that groan privately, and yet would make a show of obedience to reason, and truth?",
    "Go too now and tell me of Alexander and Philippus, and Demetrius Phalereus.",
    "Whether they understood what the common nature requireth, and could rule themselves or no, they know best themselves.",
    ...
    "So that neither fame, nor honour, nor anything else that this world doth afford, is worth the while.",
    ...
    "To comprehend the whole world together in thy mind, and the whole course of this present age to represent it unto thyself, and to fix thy thoughts upon the sudden change of every particular object.",
    "How short the time is from the generation of anything, unto the dissolution of the same; but how immense and infinite both that which was before the generation, and that which after the generation of it shall be.",
    ...
    "What are their minds and understandings; and what the things that they apply themselves unto: what do they love, and what do they hate for?",
    ...
    "Loss and corruption, is in very deed nothing else but change and alteration; and that is it, which the nature of the universe doth most delight in, by which, and according to which, whatsoever is done, is well done.",
    ...
    "How base and putrid, every common matter is!",
    "Water, dust, and from the mixture of these bones, and all that loathsome stuff that our bodies do consist of: so subject to be infected, and corrupted.",
    "And again those other things that are so much prized and admired, as marble stones, what are they, but as it were the kernels of the earth?",
    "gold and silver, what are they, but as the more gross faeces of the earth?",
    "Thy most royal apparel, for matter, it is but as it were the hair of a silly sheep, and for colour, the very blood of a shell-fish; of this nature are all other things.",
    ...
    "Doth it then also void excrements?",
    ...
    "If they can do nothing, why doest thou pray?",
    ...
    "Why not rather, that thou mayst not at either their absence or presence, be grieved and discontented: than either that thou mayst obtain them, or that thou mayst avoid them?",
    "For certainly it must needs be, that if the Gods can help us in anything, they may in this kind also.",
    "But thou wilt say perchance, 'In those things the Gods have given me my liberty: and it is in mine own power to do what I will.' But if thou mayst use this liberty, rather to set thy mind at true liberty, than wilfully with baseness and servility of mind to affect those things, which either to compass or to avoid is not in thy power, wert not thou better?",
    "And as for the Gods, who hath told thee, that they may not help us up even in those things that they have put in our own power?",
    "whether it be so or no, thou shalt soon perceive, if thou wilt but try thyself and pray.",
    ...
    "Another how he may be rid of such a one; pray thou that thou mayst so patiently bear with him, as that thou have no such need to be rid of him.",
    "Another, that he may not lose his child.",
    "Pray thou that thou mayst not fear to lose him.",
    ...
    "Is it then possible, that there should not be any impudent men in the world!",
    "Certainly it is not possible.' Desire not then that which is impossible.",
    ...
    "For whilst in general thou dost thus reason with thyself, that the kind of them must needs be in the world, thou wilt be the better able to use meekness towards every particular.",
    ...
    "For what wouldst thou have more?",
    "Unto him that is a man, thou hast done a good turn: doth not that suffice thee?",
    ...
    "As one who is altogether governed by nature, let it be thy care to observe what it is that thy nature in general doth require.",
    ...
    "Next then thou must examine, what thy nature as thou art a living sensible creature, doth require.",
    "And that, whatsoever it be, thou mayest admit of and do it, if thy nature as thou art a reasonable living creature, will not be the worse for it.",
    ...
    "Him that offends, to teach with love and meek ness, and to show him his error.",
    "But if thou canst not, then to blame thyself; or rather not thyself neither, if thy will and endeavours have not been wanting.",
    "Whatsoever it be that happens unto thee, it is that which from all time was appointed unto thee.",
    "For by the same coherence of causes, by which thy substance from all eternity was appointed to be, was also whatsoever should happen unto it, destinated and appointed.",
    ...
    "Alteration I should say, to speak truly and properly; but that I may be the better understood, I am content at this time to use that more common word.",
    ...
    "For either of these two to say, is equally absurd.",
    ...
    "Though this besides might move not so grievously to take on when any such thing doth happen, that whatsoever is dissolved, it is dissolved into those things, whereof it was compounded.",
    "For every dissolution is either a mere dispersion, of the elements into those elements again whereof everything did consist, or a change, of that which is more solid into earth; and of that which is pure and subtile or spiritual, into air.",
    "So that by this means nothing is lost, but all resumed again into those rational generative seeds of the universe; and this universe, either after a certain period of time to lie consumed by fire, or by continual changes to be renewed, and so for ever to endure.",
    "Now that solid and spiritual that we speak of, thou must not conceive it to be that very same, which at first was, when thou wert born.",
    "all this that now thou art in either kind, either for matter of substance, or of life, hath but two or three days ago partly from meats eaten, and partly from air breathed in, received all its influx, being the same then in no other respect, than a running river, maintained by the perpetual influx and new supply of waters, is the same.",
    "That therefore which thou hast since received, not that which came from thy mother, is that which comes to change and corruption.",
    ...
    "Now that thou hast taken these names upon thee of good, modest, true; of ἔμφρων, σύμφρων, ὑπέρφρων; take heed lest at any times by doing anything that is contrary, thou be but improperly so called, and lose thy right to these appellations.",
    "Or if thou do, return unto them again with all possible speed.",
    "And remember, that the word ἔμφρων notes unto thee an intent and intelligent consideration of every object that presents itself unto thee, without distraction.",
    "And the word σύμφρων, a ready and contented acceptation of whatsoever by the appointment of the common nature, happens unto thee.",
    "And the word ὑπέρφρων, a super-extension, or a transcendent, and outreaching disposition of thy mind, whereby it passeth by all bodily pains and pleasures, honour and credit, death and whatsoever is of the same nature, as matters of absolute indifferency, and in no wise to be stood upon by a wise man.",
    "These then if inviolably thou shalt observe, and shalt not be ambitious to be so called by others, both thou thyself shalt become a new man, and thou shalt begin a new life.",
    ...
    "Or, that the true and contemnplative knowledge of everything according to its own nature, might of itself, (action being subject to many lets and impediments) afford unto thee sufficient pleasure and happiness.",
    ...
    "As the spider, when it hath caught the fly that it hunted after, is not little proud, nor meanly conceited of herself: as he likewise that hath caught an hare, or hath taken a fish with his net: as another for the taking of a boar, and another of a bear: so may they be proud, and applaud themselves for their valiant acts against the Sarmatai, or northern nations lately defeated.",
    "For these also, these famous soldiers and warlike men, if thou dost look into their minds and opinions, what do they for the most part but hunt after prey?",
    ...
    "He hath got loose from the bonds of his body, and perceiving that within a very little while he must of necessity bid the world farewell, and leave all these things behind him, he wholly applied himself, as to righteousness in all his actions, so to the common nature in all things that should happen unto him.",
    "And contenting himself with these two things, to do all things justly, and whatsoever God doth send to like well of it: what others shall either say or think of him, or shall do against him, he doth not so much as trouble his thoughts with it.",
    "To go on straight, whither right and reason directed him, and by so doing to follow God, was the only thing that he did mind, that, his only business and occupation.",
    "What use is there of suspicion at all?",
    "or, why should thoughts of mistrust, and suspicion concerning that which is future, trouble thy mind at all?",
    "What now is to be done, if thou mayest search and inquiry into that, what needs thou care for more?",
    "And if thou art well able to perceive it alone, let no man divert thee from it.",
    "But if alone thou doest not so well perceive it, suspend thine action, and take advice from the best.",
    ...
    "For to hit that aright, and to speed in the prosecution of it, must needs be happiness, since it is that only which we can truly and properly be said to miss of, or miscarry in.",
    ...
    "And as for these that keep such a life, and stand so much upon the praises, or dispraises of other men, hast thou forgotten what manner of men they be?",
    ...
    "Give what thou wilt, and take away what thou wilt, saith he that is well taught and truly modest, to Him that gives, and takes away.",
    ...
    "If they cannot bear with me, let them kill me.",
    "For better were it to die, than so to live as they would have thee.",
    ...
    "Ever to represent unto thyself; and to set before thee, both the general age and time of the world, and the whole substance of it.",
    ...
    "Then to fix thy mind upon every particular object of the world, and to conceive it, (as it is indeed,) as already being in the state of dissolution, and of change; tending to some kind of either putrefaction or dispersion; or whatsoever else it is, that is the death as it were of everything in his own kind.",
    "Consider them through all actions and occupations, of their lives: as when they eat, and when they sleep: when they are in the act of necessary exoneration, and when in the act of lust.",
    ...
    "How base and slavish, but a little while ago, they were fain to be, that they might come to this; and within a very little while what will be their estate, when death hath once seized upon them.",
    ...
    "The earth, saith the poet, doth often long after the rain.",
    "So is the glorious sky often as desirous to fall upon the earth, which argues a mutual kind of love between them.",
    ...
    "Now that the world doth love it is true indeed so is it as commonly said, and acknowledged ledged, when, according to the Greek phrase, imitated by the Latins, of things that used to be, we say commonly, that they love to be.",
    "Either thou dost Continue in this kind of life and that is it, which so long thou hast been used unto and therefore tolerable: or thou doest retire, or leave the world, and that of thine own accord, and then thou hast thy mind: or thy life is cut off; and then mayst thou rejoice that thou hast ended thy charge.",
    ...
    "What is now the present estate of it, as I use it; and what is it, that I employ it about?",
    "Is it now void of reason ir no?",
    "Is it free, and separated; or so affixed, so congealed and grown together as it were with the flesh, that it is swayed by the motions and inclinations of it?",
    "He that runs away from his master is a fugitive.",
    "But the law is every man's master.",
    "He therefore that forsakes the law, is a fugitive.",
    "So is he, whosoever he be, that is either sorry, angry, or afraid, or for anything that either hath been, is, or shall be by his appointment, who is the Lord and Governor of the universe.",
    "For he truly and properly is Νόμος, or the law, as the only νέμων, or distributor and dispenser of all things that happen unto any one in his lifetime--Whatsoever then is either sorry, angry, or afraid, is a fugitive.",
    "From man is the seed, that once cast into the womb man hath no more to do with it.",
    "Another cause succeedeth, and undertakes the work, and in time brings a child (that wonderful effect from such a beginning!) to perfection.",
    "Again, man lets food down through his throat; and that once down, he hath no more to do with it.",
    "Another cause succeedeth and distributeth this food into the senses, and the affections: into life, and into strength; and doth with it those other many and marvellous things, that belong unto man.",
    "These things therefore that are so secretly and invisibly wrought and brought to pass, thou must use to behold and contemplate; and not the things themselves only, but the power also by which they are effected; that thou mayst behold it, though not with the eyes of the body, yet as plainly and visibly as thou canst see and discern the outward efficient cause of the depression and elevation of anything.",
    ...
    "Such a one is he also, who upon his bed alone, doth bewail the miseries of this our mortal life.",
    ...
    "Whatsoever it is that thou goest about, consider of it by thyself, and ask thyself, What?",
    "because I shall do this no more when I am dead, should therefore death seem grievous unto me?",
    ...
    "As that thou also perchance dost think it a happiness either to be rich, or to live in pleasure, or to be praised and commended, and so of the rest in particular.",
    ...
    "Do thou therefore if thou canst, take away that from him, that forceth him to do as he doth.",
    ...
    "And when thou doest look upon thyself, fancy unto thyself some one or other of the Cæsars; and so for every one, some one or other that hath been for estate and profession answerable unto him.",
    "Then let this come to thy mind at the same time; and where now are they all?",
    ...
    "Especially when thou shalt call to mind this also, that whatsoever is once changed, shall never be again as long as the world endureth.",
    "And thou then, how long shalt thou endure?",
    "And why doth it not suffice thee, if virtuously, and as becometh thee, thou mayest pass that portion of time, how little soever it be, that is allotted unto thee?",
    "What a subject, and what a course of life is it, that thou doest so much desire to be rid of.",
    ...
    "Be patient, therefore, until that (as a strong stomach that turns all things into his own nature; and as a great fire that turneth in flame and light, whatsoever thou doest cast into it) thou have made these things also familiar, and as it were natural unto thee.",
    "Let it not be in any man's power, to say truly of thee, that thou art not truly simple, or sincere and open, or not good.",
    "Let him be deceived whosoever he be that shall have any such opinion of thee.",
    ...
    "For thou must account that pleasure, whatsoever it be, that thou mayest do according to thine own nature.",
    ...
    "Then do the trees begin to bud again, and by the spring-time they put forth new branches.",
    "So is the generation of men; some come into the world, and others go out of it.' Of these leaves then thy children are.",
    "And they also that applaud thee so gravely, or, that applaud thy speeches, with that their usual acclamation, ἀξιοπίστως, O wisely spoken I and speak well of thee, as on the other side, they that stick not to curse thee, they that privately and secretly dispraise and deride thee, they also are but leaves.",
    "And they also that shall follow, in whose memories the names of men famous after death, is preserved, they are but leaves neither.",
    "For even so is it of all these worldly things.",
    "Their spring comes, and they are put forth.",
    "Then blows the wind, and they go down.",
    "And then in lieu of them grow others out of the wood or common matter of all things, like unto them.",
    "But, to endure but for a while, is common unto all.",
    "Why then shouldest thou so earnestly either seek after these things, or fly from them, as though they should endure for ever?",
    "Yet a little while, and thine eyes will be closed up, and for him that carries thee to thy grave shall another mourn within a while after.",
    "A good eye must be good to see whatsoever is to be seen, and not green things only.",
    "For that is proper to sore eyes.",
    "So must a good ear, and a good smell be ready for whatsoever is either to be heard, or smelt: and a good stomach as indifferent to all kinds of food, as a millstone is, to whatsoever she was made for to grind.",
    "As ready therefore must a sound understanding be for whatsoever shall happen.",
    "But he that saith, O that my children might live!",
    "and, O that all men might commend me for whatsoever I do!",
    "is an eye that seeks after green things; or as teeth, after that which is tender.",
    ...
    "Is it one that was virtuous and wise indeed?",
    "will there not some one or other be found, who thus will say to himself; 'Well now at last shall I be at rest from this pedagogue.",
    ...
    "But as for us, alas I how many things be there, for which there be many that glad would be to be rid of us.",
    ...
    "Nevertheless, whensoever thou diest, thou must not be less kind and loving unto them for it; but as before, see them, continue to be their friend, to wish them well, and meekly, and gently to carry thyself towards them, but yet so that on the other side, it make thee not the more unwilling to die.",
    "But as it fareth with them that die an easy quick death, whose soul is soon separated from their bodies, so must thy separation from them be.",
    ...
    "Use thyself; as often, as thou seest any man do anything, presently (if it be possible) to say unto thyself, What is this man's end in this his action?",
    ...
    "As for thy body, which as a vessel, or a case, compasseth thee about, and the many and curious instruments that it hath annexed unto it, let them not trouble thy thoughts.",
    ...
    "Have I done anything charitably?",
    "See that this upon all occasions may present itself unto thy mind, and never cease to think of it.",
    ...
    "And in very truth many good things are spoken by these poets; as that (for example) is an excellent passage: 'But if so be that I and my two children be neglected by the Gods, they have some reason even for that,' &c.",
    "And again, 'It will but little avail thee to storm and rage against the things themselves,' &c.",
    "Again, 'To reap one's life, as a ripe ear of corn;' and whatsoever else is to be found in them, that is of the same kind.",
    "After the tragedy, the ancient comedy was brought in, which had the liberty to inveigh against personal vices; being therefore through this her freedom and liberty of speech of very good use and effect, to restrain men from pride and arrogancy.",
    "To which end it was, that Diogenes took also the same liberty.",
    "After these, what were either the Middle, or New Comedy admitted for, but merely, (Or for the most part at least) for the delight and pleasure of curious and excellent imitation?",
    "'It will steal away; look to it,' &c.",
    "Why, no man denies, but that these also have some good things whereof that may be one: but the whole drift and foundation of that kind of dramatical poetry, what is it else, but as we have said?",
    ...
    "If this be so; that the most perfect and general nature of all natures should in her operation come short of the skill of arts, is most improbable.",
    "Now common is it to all arts, to make that which is worse for the better's sake.",
    "Much more then doth the common nature do the same.",
    "Hence is the first ground of justice.",
    ...
    "Let then thine own judgment and opinion concerning those things be at rest; and as for the things themselves, they stand still and quiet, without any noise or stir at all; and so shall all pursuing and flying cease.",
    ...
    "let him look to that, upon what grounds he does it: my care shall be that I may never be found either doing or speaking anything that doth truly deserve contempt.",
    ...
    "what needs this profession of thine?",
    "the thing itself will show it.",
    "It ought to be written upon thy forehead.",
    "No sooner thy voice is heard, than thy countenance must be able to show what is in thy mind: even as he that is loved knows presently by the looks of his sweetheart what is in her mind.",
    ...
    "Above all things, that must be avoided.",
    ...
    "And as for other men's either foolishness or wickedness, that it may not trouble and grieve thee; first generally thus; What reference have I unto these?",
    "and that we are all born for one another's good: then more particularly after another consideration; as a ram is first in a flock of sheep, and a bull in a herd of cattle, so am I born to rule over them.",
    "Begin yet higher, even from this: if atoms be not the beginning of all things, than which to believe nothing can be more absurd, then must we needs grant that there is a nature, that doth govern the universe.",
    "If such a nature, then are all worse things made for the better's sake; and all better for one another's sake.",
    "Secondly, what manner of men they be, at board, and upon their beds, and so forth.",
    ...
    "Thirdly, that if they do these things rightly, thou hast no reason to be grieved.",
    "But if not rightly, it must needs be that they do them against their wills, and through mere ignorance.",
    "For as, according to Plato's opinion, no soul doth willingly err, so by consequent neither doth it anything otherwise than it ought, but against her will.",
    ...
    "Fourthly, that thou thyself doest transgress in many things, and art even such another as they are.",
    ...
    "Fifthly, that whether they have sinned or no, thou doest not understand perfectly.",
    "For many things are done by way of discreet policy; and generally a man must know many things first, before he be able truly and judiciously to judge of another man's action.",
    ...
    "Seventhly, that it is not the sins and transgressions themselves that trouble us properly; for they have their existence in their minds and understandings only, that commit them; but our own opinions concerning those sins.",
    ...
    "reasoning with thyself that it is not shameful.",
    ...
    "As for example; My son, we were not born for this, to hurt and annoy one another; it will be thy hurt not mine, my son: and so to show him forcibly and fully, that it is so in very deed: and that neither bees do it one to another, nor any other creatures that are naturally sociable.",
    "But this thou must do, not scoffingly, not by way of exprobation, but tenderly without any harshness of words.",
    ...
    "But on the other side thou must take heed, as much to flatter them, as to be angry with them: for both are equally uncharitable, and equally hurtful.",
    ...
    "For the nearer everything is unto unpassionateness, the nearer it is unto power.",
    "And as grief doth proceed from weakness, so doth anger.",
    "For both, both he that is angry and that grieveth, have received a wound, and cowardly have as it were yielded themselves unto their affections.",
    "If thou wilt have a tenth also, receive this tenth gift from Hercules the guide and leader of the Muses: that is a mad man's part, to look that there should be no wicked men in the world, because it is impossible.",
    "Now for a man to brook well enough, that there should be wicked men in the world, but not to endure that any should transgress against himself, is against all equity, and indeed tyrannical.",
    ...
    "He that hath not one and the self-same general end always as long as he liveth, cannot possibly be one and the self-same man always.",
    "But this will not suffice except thou add also what ought to be this general end.",
    ...
    "The Pythagoreans were wont betimes in the morning the first thing they did, to look up unto the heavens, to put themselves in mind of them who constantly and invariably did perform their task: as also to put themselves in mind of orderliness, or good order, and of purity, and of naked simplicity.",
    "For no star or planet hath any cover before it.",
    ...
    "'My heart smiled within me.' 'They will accuse even virtue herself; with heinous and opprobrious words.' XXIX.",
    ...
    "'As often as a father kisseth his child, he should say secretly with himself' (said Epictetus,) 'tomorrow perchance shall he die.' But these words be ominous.",
    "No words ominous (said he) that signify anything that is natural: in very truth and deed not more ominous than this, 'to cut down grapes when they are ripe.' Green grapes, ripe grapes, dried grapes, or raisins: so many changes and mutations of one thing, not into that which was not absolutely, but rather so many several changes and mutations, not into that which hath no being at all, but into that which is not yet in being.",
    ...
    "Socrates said, 'What will you have?",
    "the souls of reasonable, or unreasonable creatures?",
    "Of those whose reason is sound and perfect?",
    "or of those whose reason is vitiated and corrupted?",
    "Of those whose reason is sound and perfect.",
    "Why then labour ye not for such?",
    "What then do ye so strive and contend between you?' THE TWELFTH BOOK I.",
    ...
    "For the left hand we see, which for the most part lieth idle because not used; yet doth it hold the bridle with more strength than the right, because it hath been used unto it.",
    ...
    "For what shall he do that hath such an habit?",
    "If thou therefore beest powerful and eloquent, remedy it if thou canst.",
    "If it be not fitting, do it not.",
    ...
    "yet a little while, and thou art no more: no more will any, either of those things that now thou seest, or of those men that now are living, be any more.",
    ...
    "No operation whatsoever it he, ceasing for a while, can be truly said to suffer any evil, because it is at an end.",
    ...
    "Then consider what's now become of all those things.",
    "All is turned to smoke; all to ashes, and a mere fable; and perchance not so much as a fable.",
    ...
    "or wouldst thou grow, and then decrease again?",
    ...
    "as a citizen thou hast lived, and conversed in this great city the world.",
    ...
    "As for thyself; thou hast to do with neither.",
